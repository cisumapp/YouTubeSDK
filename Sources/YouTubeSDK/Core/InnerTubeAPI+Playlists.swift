...
public extension InnerTubeAPI {
    ...
    internal func parsePlaylistsForTesting(_ json: [String: Any]) throws -> [PlaylistInfo] {
    ...
    func fetchUserPlaylists() async throws -> [PlaylistInfo] {
        ...
        // the fixed browse ID VLWL (handled correctly by fetchPlaylistInternalVideos).
    ...
    func fetchPlaylistInternalVideos(playlistId: String, continuationToken: String? = nil) async throws -> InternalVideoGroup {
    ...
    private func parsePlaylists(from json: [String: Any]) throws -> [PlaylistInfo] {
        ...
        func extractPlaylist(from renderer: [String: Any]) -> PlaylistInfo? {
            ...
            // InternalVideo count may be a plain string or in a text object.
            let count: Int? =
        ...
        /// for system playlists like Watch Later "WL" and Liked InternalVideos "LL").
