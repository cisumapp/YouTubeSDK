...
//
// Mirrors Android's InternalVideoStateController + WatchHistory reporting.
//
// Lifecycle per video:
    ...
    public func transition(
        ...
        return {
            ...
            if oldSegStart == nil {
                ...
                await api.reportPlaybackStarted(videoId: oldInternalVideoId, cpn: oldCPN, trackingURLs: oldURLs)
            }
