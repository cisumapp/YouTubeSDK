...
public extension YouTubeClient {
    ...
    func createPlaylist(title: String, description: String? = nil, privacy: String = "PRIVATE") async throws -> String {
        ...
        guard let json = try? JSONSerialization.jsonObject(with: data) as? [String: Any],
              let playlistId = json["playlistId"] as? String
        else {
    ...
    func deletePlaylist(id: String) async throws {
        ...
        _ = try await network.sendComplexRequest("playlist/delete", body: body)
    }
    ...
    func addVideoToPlaylist(videoId: String, playlistId: String) async throws {
        ...
        _ = try await network.sendComplexRequest("browse/edit_playlist", body: body)
    }
