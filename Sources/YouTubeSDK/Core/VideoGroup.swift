...
// MARK: - InternalVideoGroup

/// A named collection of videos that maps to an Android `InternalVideoGroup`.
public struct InternalVideoGroup: Identifiable, Sendable {
    public let id: UUID
...
public struct SearchResult: Identifiable, Sendable {
    ...
    public init(id: UUID = UUID(), videos: [InternalVideo] = [], query: String, nextPageToken: String? = nil) {
        self.id = id
        self.videos = videos
        self.query = query
        self.nextPageToken = nextPageToken
...
// MARK: - InternalVideoFormat

public struct InternalVideoFormat: Identifiable, Hashable, Sendable {
    public let id: UUID
    public var itag: Int
    ...
    public init(id: UUID = UUID(), itag: Int = 0, label: String, width: Int, height: Int, fps: Int, mimeType: String, url: URL? = nil, bitrate: Int? = nil) {
        self.id = id
        self.itag = itag
        self.label = label
        self.width = width
